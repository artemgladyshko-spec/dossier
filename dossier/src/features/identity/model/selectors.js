export function selectIdentityDetails(dossier, t) {
  return {
    personal: [
      ...
      { label: t('field.gender'), value: dossier.identity.personalInfo.gender },
      { label: t('field.taxId'), value: dossier.identity.personalInfo.taxId },
      { label: t('field.citizenship'), value: dossier.identity.personalInfo.citizenship },
      { label: t('identity.address'), value: dossier.identity.personalInfo.registeredAddress },
    ],
    passport: [
      ...
      { label: t('field.issuedBy'), value: dossier.identity.passport.issuedBy },
    ...
    contacts: [
      ...
      { label: t('field.emergencyContact'), value: dossier.identity.contacts.emergencyContact },
    ],
  }
}
